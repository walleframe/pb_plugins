...
func (x *x{{.Name}}) SetEx(ctx context.Context, pb proto.Message, expire time.Duration) error { {{- Import "time" "time.Duration"}}
	data, err := proto.Marshal(pb)
	if err != nil {
		return err
	}
...
func (x *x{{.Name}}) Get(ctx context.Context, pb proto.Message) error {
	...
	return nil
} {{UsePackage "util" "StringToBytes"}}{{UsePackage "proto" "Marshal/Unmarshal/Message"}}